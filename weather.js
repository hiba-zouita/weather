...
const Weather=(props)=>{
    return(
      <div className="info" >
          ...
          {
              props.temp && <p className="info_key">Temperature<span className="info_value"> {props.temp}</span></p>
          }
          {
          ...
          {
              props.error && <p className="info_key">error <span className="info_value"> {props.temp} !!!</span></p>
          }
